...
import profileImg from '../../assets/test-pp.png'; 
import pp from '../../assets/pp.png'; 
import ppa from '../../assets/pp-a.jpg'; 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            <FadeIn delay={0}>
              <div className="inline-flex items-center gap-2.5 px-[18px] py-[11px] mb-8 bg-linear-2-r from-primary/10 via-primary/15 to-primary/20 border border-primary/20 rounded-full">
            ...
            <FadeIn delay={200}>
              <p className="text-lg text-white/70 max-w-[550px] mb-8">
                MERN full stack developer and UI/UX designer with over four years of experience crafting scalable, user-centric digital solutions. Skilled in building responsive web applications, intuitive interfaces, and seamless user experiences. Possesses knowledge in cybersecurity and project management, ensuring secure, efficient, and well-structured project delivery from concept to completion.
              </p>
            </FadeIn>
